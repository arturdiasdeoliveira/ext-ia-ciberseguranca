...
| Nome | RA | Curso |
| --- | --- | --- |
| `Artur Dias de Oliveira` | `252635` | `Ciência da Computação` |
| `Luana Oliveira dos Santos` | `230559` | `Engenharia da Computação` |
| `Tiago Gutiérrez García-Urrutia` | `301315` | `Engenharia Civil` |
| `Rayssa Moreno Silva Aguiar` | `239313` | `Engenharia Elétrica` |
| `Camila Parizoto` | `301291` | `Engenharia Elétrica` |
